...
See `RELEASE_NOTES.md` for an example release summary.

## GitHub Release

If you want to publish this project on GitHub, follow these steps:

1. Initialize a git repository:

   ```bash
   git init
   git add live_sonification_opencv.py README.md requirements.txt RELEASE_NOTES.md
   git commit -m "Initial release: live sonification with OpenCV"
   ```
...
4. Optionally use GitHub CLI to publish the release:

   ```bash
   gh release create v1.0.0 \
     --title "Blood Music Live Sonification" \
